...
const About = (props) => {
  return (
    <div className="aboutMe" ref={props.aboutRef}>
      <h2>About me</h2>
      <p>
        My name is Jevon Fillette. I am a Web Developer from Philadelphia, PA with a background in Finance. I pride myself on building clean, efficient, and scalable websites.  I have a deep passion for sports and gaming and love the excitement of creating apps that users enjoy interacting with.  Software development is a lifelong journey, and I make it a priority to stay up to date in the ever changing landscape.  My former career as a Finance Manager lends many skills that apply to web development, such as prioritization, problem solving, documentation, attention to detail, and data integrity.
      </p>
      <p>
